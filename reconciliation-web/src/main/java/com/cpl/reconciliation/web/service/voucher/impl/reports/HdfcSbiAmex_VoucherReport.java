...
//import static com.cpl.core.api.constant.Formatter.DDMMYYYY_SLASH;
//
//@Slf4j
//@Data
//@Service
//public class HdfcSbiAmex_VoucherReport implements VoucherReportDownloadService {
//
...
//
//            XSSFCell cell11 = row.createCell(col++);
//            cell11.setCellValue(bankingVoucherEntries.getDate().getMonth().length(bankingVoucherEntries.getDate().isLeapYear()));
//
//            XSSFCell cell12 = row.createCell(col++);
//            cell12.setCellValue(bankingVoucherEntries.getStoreCode());
//
...
//
//                XSSFCell date = row.createCell(col++);
//                if (bankingVoucherEntries.getBank().equals(Bank.HDFC))
//                    date.setCellValue(bankingVoucherEntries.getChequeNo().substring(bankingVoucherEntries.getChequeNo().length() - 9));
//                else if (bankingVoucherEntries.getBank().equals(Bank.SBI))
//                    date.setCellValue(bankingVoucherEntries.getDate().format(DDMMYYYY_DASH));
//                else if (bankingVoucherEntries.getBank().equals(Bank.AMEX))
//                    date.setCellValue(bankingVoucherEntries.getDate().format(DDMMYYYY_SLASH));
//
//            } else col += 3;
//
//            XSSFCell cell19 = row.createCell(col++);
...
//            if (bankingVoucherEntries.getPaymentType().equals(PaymentType.CARD)) {
//                if (bankingVoucherEntries.getBank().equals(Bank.HDFC) ||
//                        (bankingVoucherEntries.getBank().equals(Bank.SBI) && bankingVoucherEntries.getLedger().equals(Ledger.BANK_ACCOUNT)))
//                    cell20.setCellValue("SALECARDS");
//            } else cell20.setCellValue("SALEUPI");
//
//        }
//        return lastRow;
//
