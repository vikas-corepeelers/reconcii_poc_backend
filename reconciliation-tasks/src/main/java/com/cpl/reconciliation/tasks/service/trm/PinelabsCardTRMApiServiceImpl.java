...
//import com.cpl.reconciliation.domain.models.Transaction;
...
//import com.cpl.reconciliation.tasks.service.trm.parser.PinelabsCardTrmFileParser;
//import lombok.Data;
...
//@Slf4j
//@Service
//public class PinelabsCardTRMApiServiceImpl extends AbstractService implements DataService {
//
//    private final TRMDao trmDao;
//    private final PinelabsDataLogRepository pinelabsDataLogRepository;
//    private final PinelabsCardTrmFileParser pinelabsCardTrmFileParser;
//    private final RestTemplate restTemplate;
//    private final String url = "https://analytics.pinelabs.com/public/rest/data/pineanalytics/transactionDatawithChangeNo.rest";
...
//    @PostConstruct
//    private void init() {
//        log.info("Pinelabs card TRM API data Injector Initialized");
//    }
//
//    @Override
//    public DataSource getDataSource() {
//        return DataSource.PineLabs_TRM_CARD;
//    }
//
//    @Override
//    public void executeTask() {
//        AtomicReference<Long> offset = new AtomicReference<>(pinelabsDataLogRepository.findMaxOffset(PaymentType.CARD));
//        log.info("PINELABS CARD TRM data sync job Started with offset {}", offset.get());
//        TransactionRequest request = new TransactionRequest();
//        request.setUserName(username);
//        request.setPassword(password);
//        request.setMaxChangeNo(Objects.isNull(offset.get()) ? "0" : String.valueOf(offset.get()));
...
//            log.info("TRM data: {}", transactionResponse);
//            List<Transaction> transactions = transactionResponse.getTransactionData();
...
//                    trm.setTrmAmount(transaction.getAmount());
//                    //
...
//                    //Card Details
//                    trm.setAuthCode(transaction.getApprCode());
//                    trm.setCardType(transaction.getCardCategory());
//                    trm.setNetworkType(transaction.getCardType());
//                    trm.setCardNumber(transaction.getPan());
//                    //
//                    trm.setTransactionDate(transaction.getDate());
//                    trm.setSettlementDate(transaction.getDate());
...
//                    trm.setUid(getComposite(transaction.getRrn(), transaction.getApprCode(), transaction.getPan()));
//                    trm.setIsReversed(transaction.getIsReversed());
//                    trm.setStatus(transaction.getStatus());
//                    trm.setTranscType(transaction.getTranscType());
//                    offset.set(transaction.getChangeNo());
//                    trpEntities.add(trm);
//                    if (trpEntities.size() >= 1000) {
//                        log.info("Pinelabs CARD TRM batch {} write invoked", trpEntities.size());
...
//                pinelabsDataLog.setPaymentType(PaymentType.CARD);
...
//            }
//        } else {
//            throw new RuntimeException("API call failed with status code: " + responseEntity.getStatusCode());
//        }
//        log.info("PINELABS CARD TRM data sync job Stopped with offset {}", offset.get());
//    }
//
...
//                try (inputStream) {
//                    recordCount += pinelabsCardTrmFileParser.readTransactionsFromCSV(inputStream);
//                }
//            }
