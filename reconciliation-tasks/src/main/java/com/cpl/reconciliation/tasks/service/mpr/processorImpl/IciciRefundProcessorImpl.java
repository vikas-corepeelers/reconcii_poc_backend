...
//@Service
//@Slf4j
//public class IciciRefundProcessorImpl implements MessageProcessor {
...
//                if (fileName != null && isRefundReport(fileName)) {
...
//                 if (isRefundReport(path.toFile().getName())) {
...
//    }
//
//    private boolean isRefundReport(String fileName) {
//        return fileName.matches(".*REFUND_REPORT.*\\.xlsx");
//
//    }
//
...
//                            report.setRefundInitiationSource(row.getCell(18) == null ? null : row.getCell(18).getStringCellValue());
//                            report.setOriginalMerchantTransactionId(row.getCell(19) == null ? null : row.getCell(19).getStringCellValue());
//                            report.setId(report.getOriginalMerchantTransactionId());
